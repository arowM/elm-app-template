...
require("../style/reset.scss"),require("../style/app.scss");var e=require("../Main.elm"),s=e.Elm,n=s.Main.init({node:document.body.appendChild(document.createElement("span")),flags:null});
},{"../style/reset.scss":"dxOF","../style/app.scss":"dxOF","../Main.elm":"8asW"}]},{},["QvaY"], null)
//# sourceMappingURL=/elm-app-template/js.c0e0b71f.js.map